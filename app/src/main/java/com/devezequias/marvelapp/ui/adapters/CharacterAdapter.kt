package com.devezequias.marvelapp.ui.adapters
...
import com.devezequias.marvelapp.databinding.ItemCharacterBinding
import com.devezequias.marvelapp.data.model.character.CharacterModel
import com.devezequias.marvelapp.util.limitDescripition
import com.devezequias.marvelapp.util.loadImage
    ...
    override fun onBindViewHolder(holder: CharacterViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            if (character.description == "") {
                ...
                tvDescriptionCharacter.text = character.description.limitDescripition(100)
            }
